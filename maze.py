...
wall1 = Wall(14,88,39, 29, 100, 120, 7)
wall2 = Wall(12,99,199,100,20,100,10)
wall3 = Wall(88,0,55,35,35,45,45)
win_w = 700
win_h = 500
window = display.set_mode((win_w, win_h))
display.set_caption('ДРОВА')
...
win = font.render('НАВЕРНИ ГОВНА ОЛУХ', True, (127,45,89))
lose = font.render('СЫН ПОМОЙКИ НИЩЕЙ',True,(254, 230, 70))
while game:
    for e in event.get():
        if e.type == QUIT:
            game = False
